...
def index2():
	...
	os.system("dir")
	os.system('python driverdrowsy1.py -p shape_predictor_68_face_landmarks.dat -a alarm.wav')
...
def index4():
        ...
        #return render_template('index2.html')
	os.system("dir")
	os.system('python driverdrowsy.py -p shape_predictor_68_face_landmarks.dat -a alarm.wav')
	return render_template('index3.html')
